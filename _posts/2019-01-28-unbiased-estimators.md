...
In causal inference, we want to parse the effect of a treatment on some outcome. Without unbiased estimates of an outcome with respect to both a treated group and a control group, any inferences made on the basis of your data could be incorrect! And this is often the case -- a lot of inferences are drawn from *observational* rather than experimental data. For example, let's say I had a survey, and I wanted to know the effect of giving $5 to my survey-takers. In this case, the outcome is whether the survey is completed or not and the treatment is whether the monetary incentive is given or not. If the pool of people I polled contained both my friends and strangers, one can imagine that my friends' outcome would not be affected by my treatment (they'd always fill out the survey, as a favor), but strangers' responses did. If my friends comprised 50% of my training data, but I then wanted to generalize this result to the larger population, the bias that stems from my model being based on mostly just my friends could cause me to be very inaccurate in my estimate of the causal effect of bribing survey-takers (in this case, I'd underpredict the effect size). More examples can be found in fields like advertising or medicine, where we could end up wasting money, or worse, missing out on powerful medicines.
